...
import static org.firstinspires.ftc.teamcode.pedroPathing.TestAutoStuff.PathState.shoot_collect1;
import static org.firstinspires.ftc.teamcode.pedroPathing.TestAutoStuff.PathState.shoot_end;
import static org.firstinspires.ftc.teamcode.pedroPathing.TestAutoStuff.PathState.start_shoot;
...
@Autonomous(name= "pedro's path LEFT ON BACK")
public class TestAutoStuff extends OpMode{
    ...
    private final Pose shootPose = new Pose(71.245, 23.510, Math.toRadians(122));
